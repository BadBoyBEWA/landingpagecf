  ...
  return (
    <header className="fixed top-0 w-full z-50 bg-white/60 backdrop-blur-2xl no-line tonal-shift-boundary shadow-[0px_24px_48px_rgba(26,28,28,0.06)] scale-95 active:scale-90 duration-200">
      <div className="flex justify-between items-center px-8 py-4 w-full max-w-screen-2xl mx-auto">
        <div className="text-2xl font-black tracking-tighter text-neutral-900 font-headline uppercase">JOIN FLAGG</div>
        ...
        <button 
          onClick={onGetAccess}
          className="hidden md:inline-flex items-center justify-center px-6 py-2.5 font-headline font-bold text-sm tracking-widest text-on-primary bg-gradient-to-tr from-primary to-primary-container rounded shadow-[0px_24px_48px_rgba(26,28,28,0.06)] hover:brightness-110 transition-all uppercase"
        >
          JOIN NOW
        </button>
